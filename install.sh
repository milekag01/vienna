...
echo "  vienna spawn <name> --branch <branch> Create isolated environment"
echo "  vienna spawn --ticket COM-4521        Spawn from Linear ticket + open Cursor agent"
echo "  vienna list                           Show all instances"
echo "  vienna destroy <name>                 Tear down an instance"
